...
func save_game(score: float, cps: float, cpc: int, level: int, CPS1: int, CPS2: int, CPS3: int, CPS4: int, CPS5: int, CPS6: int, ca1: int, ca2: int, ca3: int, ca4: int, ca5: int, ca6: int) -> void:
...
func load_game() -> Dictionary:
	...
	if file:
		...
		file.close()
		if saveData != null and saveData.has("score") and saveData.has("cps") and saveData.has("cpc") and saveData.has("level")  and saveData.has("CPS1") and saveData.has("CPS2") and saveData.has("CPS3") and saveData.has("CPS4") and saveData.has("CPS5") and saveData.has("CPS6")  and saveData.has("ca1") and saveData.has("ca2") and saveData.has("ca3") and saveData.has("ca4") and saveData.has("ca5") and saveData.has("ca6"):
			return saveData
		else:
